defmodule PhoenixUI.Components.Heroicon do
  ...
  defp render_markup(%{name: "academic-cap", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "academic-cap", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # adjustments
  defp render_markup(%{name: "adjustments", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "adjustments", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # annotation
  defp render_markup(%{name: "annotation", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "annotation", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # archive
  defp render_markup(%{name: "archive", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "archive", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-circle-down
  defp render_markup(%{name: "arrow-circle-down", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-circle-down", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-circle-left
  defp render_markup(%{name: "arrow-circle-left", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-circle-left", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-circle-right
  defp render_markup(%{name: "arrow-circle-right", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-circle-right", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-circle-up
  defp render_markup(%{name: "arrow-circle-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-circle-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-narrow-down
  defp render_markup(%{name: "arrow-narrow-down", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-narrow-down", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-narrow-left
  defp render_markup(%{name: "arrow-narrow-left", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-narrow-left", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-narrow-right
  defp render_markup(%{name: "arrow-narrow-right", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-narrow-right", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-narrow-up
  defp render_markup(%{name: "arrow-narrow-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-narrow-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-sm-down
  defp render_markup(%{name: "arrow-sm-down", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-sm-down", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-sm-left
  defp render_markup(%{name: "arrow-sm-left", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-sm-left", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-sm-right
  defp render_markup(%{name: "arrow-sm-right", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-sm-right", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrow-sm-up
  defp render_markup(%{name: "arrow-sm-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrow-sm-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # arrows-expand
  defp render_markup(%{name: "arrows-expand", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "arrows-expand", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # badge-check
  defp render_markup(%{name: "badge-check", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "badge-check", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # ban
  defp render_markup(%{name: "ban", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "ban", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # bookmark-alt
  defp render_markup(%{name: "bookmark-alt", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "bookmark-alt", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # cash
  defp render_markup(%{name: "cash", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "cash", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # chart-square-bar
  defp render_markup(%{name: "chart-square-bar", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "chart-square-bar", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # chat-alt-2
  defp render_markup(%{name: "chat-alt-2", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "chat-alt-2", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # chat-alt
  defp render_markup(%{name: "chat-alt", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "chat-alt", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # chat
  defp render_markup(%{name: "chat", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "chat", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # chip
  defp render_markup(%{name: "chip", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "chip", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # clipboard-check
  defp render_markup(%{name: "clipboard-check", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "clipboard-check", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # clipboard-copy
  defp render_markup(%{name: "clipboard-copy", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "clipboard-copy", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # clipboard-list
  defp render_markup(%{name: "clipboard-list", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "clipboard-list", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"/>
  ...
  # cloud-download
  defp render_markup(%{name: "cloud-download", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "cloud-download", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # cloud-upload
  defp render_markup(%{name: "cloud-upload", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "cloud-upload", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # code
  defp render_markup(%{name: "code", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "code", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # collection
  defp render_markup(%{name: "collection", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "collection", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # color-swatch
  defp render_markup(%{name: "color-swatch", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "color-swatch", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # cursor-click
  defp render_markup(%{name: "cursor-click", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "cursor-click", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # database
  defp render_markup(%{name: "database", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "database", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # desktop-computer
  defp render_markup(%{name: "desktop-computer", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "desktop-computer", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # device-mobile
  defp render_markup(%{name: "device-mobile", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "device-mobile", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # document-add
  defp render_markup(%{name: "document-add", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "document-add", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # document-download
  defp render_markup(%{name: "document-download", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "document-download", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # document-remove
  defp render_markup(%{name: "document-remove", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "document-remove", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # document-report
  defp render_markup(%{name: "document-report", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "document-report", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # document-search
  defp render_markup(%{name: "document-search", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "document-search", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "dots-circle-horizontal", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "dots-circle-horizontal", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # dots-horizontal
  defp render_markup(%{name: "dots-horizontal", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "dots-horizontal", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # dots-vertical
  defp render_markup(%{name: "dots-vertical", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "dots-vertical", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # download
  defp render_markup(%{name: "download", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "download", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # duplicate
  defp render_markup(%{name: "duplicate", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "duplicate", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # emoji-happy
  defp render_markup(%{name: "emoji-happy", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "emoji-happy", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # emoji-sad
  defp render_markup(%{name: "emoji-sad", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "emoji-sad", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # exclamation
  defp render_markup(%{name: "exclamation", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "exclamation", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # external-link
  defp render_markup(%{name: "external-link", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "external-link", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # eye-off
  defp render_markup(%{name: "eye-off", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "eye-off", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # fast-forward
  defp render_markup(%{name: "fast-forward", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "fast-forward", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # filter
  defp render_markup(%{name: "filter", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "filter", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # folder-add
  defp render_markup(%{name: "folder-add", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "folder-add", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # folder-download
  defp render_markup(%{name: "folder-download", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "folder-download", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # folder-remove
  defp render_markup(%{name: "folder-remove", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "folder-remove", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # globe
  defp render_markup(%{name: "globe", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "globe", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # hand
  defp render_markup(%{name: "hand", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "hand", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # inbox-in
  defp render_markup(%{name: "inbox-in", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "inbox-in", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # library
  defp render_markup(%{name: "library", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "library", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # lightning-bolt
  defp render_markup(%{name: "lightning-bolt", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "lightning-bolt", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # location-marker
  defp render_markup(%{name: "location-marker", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "location-marker", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # login
  defp render_markup(%{name: "login", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "login", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # logout
  defp render_markup(%{name: "logout", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "logout", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # mail-open
  defp render_markup(%{name: "mail-open", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "mail-open", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # mail
  defp render_markup(%{name: "mail", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "mail", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # menu-alt-1
  defp render_markup(%{name: "menu-alt-1", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "menu-alt-1", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # menu-alt-2
  defp render_markup(%{name: "menu-alt-2", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "menu-alt-2", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # menu-alt-3
  defp render_markup(%{name: "menu-alt-3", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "menu-alt-3", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # menu-alt-4
  defp render_markup(%{name: "menu-alt-4", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "menu-alt-4", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # menu
  defp render_markup(%{name: "menu", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "menu", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # minus-sm
  defp render_markup(%{name: "minus-sm", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "minus-sm", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # music-note
  defp render_markup(%{name: "music-note", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "music-note", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # office-building
  defp render_markup(%{name: "office-building", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "office-building", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # pencil-alt
  defp render_markup(%{name: "pencil-alt", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "pencil-alt", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # phone-incoming
  defp render_markup(%{name: "phone-incoming", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "phone-incoming", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # phone-missed-call
  defp render_markup(%{name: "phone-missed-call", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "phone-missed-call", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
  ...
  # phone-outgoing
  defp render_markup(%{name: "phone-outgoing", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "phone-outgoing", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # photograph
  defp render_markup(%{name: "photograph", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "photograph", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # plus-sm
  defp render_markup(%{name: "plus-sm", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "plus-sm", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # puzzle
  defp render_markup(%{name: "puzzle", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "puzzle", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # qrcode
  defp render_markup(%{name: "qrcode", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "qrcode", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # receipt-tax
  defp render_markup(%{name: "receipt-tax", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "receipt-tax", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # refresh
  defp render_markup(%{name: "refresh", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "refresh", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # reply
  defp render_markup(%{name: "reply", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "reply", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # rewind
  defp render_markup(%{name: "rewind", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "rewind", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # save-as
  defp render_markup(%{name: "save-as", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "save-as", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # save
  defp render_markup(%{name: "save", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "save", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # search-circle
  defp render_markup(%{name: "search-circle", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "search-circle", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # search
  defp render_markup(%{name: "search", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "search", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # selector
  defp render_markup(%{name: "selector", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "selector", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # sort-ascending
  defp render_markup(%{name: "sort-ascending", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "sort-ascending", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # sort-descending
  defp render_markup(%{name: "sort-descending", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "sort-descending", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # speakerphone
  defp render_markup(%{name: "speakerphone", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "speakerphone", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # status-offline
  defp render_markup(%{name: "status-offline", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "status-offline", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # status-online
  defp render_markup(%{name: "status-online", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "status-online", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # support
  defp render_markup(%{name: "support", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "support", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # switch-horizontal
  defp render_markup(%{name: "switch-horizontal", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "switch-horizontal", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # switch-vertical
  defp render_markup(%{name: "switch-vertical", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "switch-vertical", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # table
  defp render_markup(%{name: "table", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "table", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # template
  defp render_markup(%{name: "template", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "template", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # terminal
  defp render_markup(%{name: "terminal", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "terminal", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # thumb-down
  defp render_markup(%{name: "thumb-down", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "thumb-down", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # thumb-up
  defp render_markup(%{name: "thumb-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "thumb-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # translate
  defp render_markup(%{name: "translate", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "translate", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # trending-down
  defp render_markup(%{name: "trending-down", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "trending-down", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # trending-up
  defp render_markup(%{name: "trending-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "trending-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # upload
  defp render_markup(%{name: "upload", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "upload", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # user-add
  defp render_markup(%{name: "user-add", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "user-add", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # user-remove
  defp render_markup(%{name: "user-remove", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "user-remove", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # view-boards
  defp render_markup(%{name: "view-boards", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "view-boards", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # view-grid-add
  defp render_markup(%{name: "view-grid-add", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "view-grid-add", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # view-grid
  defp render_markup(%{name: "view-grid", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "view-grid", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # view-list
  defp render_markup(%{name: "view-list", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "view-list", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # volume-off
  defp render_markup(%{name: "volume-off", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "volume-off", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # volume-up
  defp render_markup(%{name: "volume-up", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "volume-up", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # x
  defp render_markup(%{name: "x", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "x", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # zoom-in
  defp render_markup(%{name: "zoom-in", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "zoom-in", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  # zoom-out
  defp render_markup(%{name: "zoom-out", variant: "outline"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
  ...
  defp render_markup(%{name: "zoom-out", variant: "solid"} = assigns) do
    ~H"""
    <svg {@icon_attrs} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"/>
